...
function Layout({ children }: PropsWithChildren) {
    ...
    return (
        <main className="bg-white w-11/12 lg:w-9/12 mx-auto grid lg:grid-cols-[400px_minmax(850px,_1fr)_100px]">
            <div className="md:sticky top-0 pt-10 z-0 w-full h-[45vh] md:h-screen flex flex-col justify-around">
                <Header />
            </div>
