...
function Header() {
  ...
  return (
    <>
      <div>
        <h1 className="text-3xl pt-3 font-semibold">Rayan Reynaldo</h1>
      ...
      <div className="flex gap-x-2 mb-5 sticky top-0 z-50">
        <SocialLink
          ...
          network="github"
          href="https://github.com/imdevry"
        />
        <SocialLink
          classes="hover:scale-110"
          network="email"
          href="mailto:official@reynaldorayan.dev"
        />
        <SocialLink
          classes="hover:scale-110"
          network="facebook"
          href="https://www.facebook.com/reynaldorayanvega"
        />
        <SocialLink
          classes="hover:scale-110"
          network="linkedin"
          href="https://www.linkedin.com/in/imdevry"
        />
      </div>
    </>
  );
